...
<head>
    ...
    <title>Absensi | Persetujuan</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="mt-5 mt-lg-5 px-0 pt-3">
                ...
                <div class="container-fluid">
                    <h3>A b s e n s i </h3>
                    <div class="row">
                        <div class="col card-body tumpul bg-light-biru text-primary" style="background-color: #ffe699;">
                            <i class="fas fa-fw fa-lightbulb"></i>
                            <span>B e r i k u t &ensp; a d a l a h &ensp; d a f t a r &ensp; P e r m i n t a a n &ensp; K o r e k s i &ensp; A b s e n s i</span>
                        </div>
                    </div>
                        ...
                        <div class="col-12 card tumpul table-borderless">
                            <table id="datatablesSimple" class="table table-hover table-responsive border" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    $no = 1;
                                    error_reporting(1);
                                    $query = "SELECT * FROM absensi a INNER JOIN nusametal_id b ON a.seksi=b.seksi WHERE a.approval='$_SESSION[role]'";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a href='index.php?kode=<?php echo $tampil['id'] ?>'><i class="btn fa-solid fa-check" style="background-color:green; color: white; height: 30px;" onclick="return confirm('Yakin Untuk Mengizinkan?');"></i></a> </td>
                                            <td style="text-align: center;"><a href='index.php?kode1=<?php echo $tampil['id'] ?>'><i class="btn fa-solid fa-x" style="background-color:red; color: white; height: 30px;" onclick="return confirm('Yakin Untuk Menolak?');"></i></a> </td>
                                        </tr>
                                    <?php
                                        $no++;
                                    }
                                ...
                                if (isset($_GET['kode'])) {
                                    ...
                                    if ($_SESSION['role'] == 0) {
                                        mysqli_query($conn, "UPDATE absensi SET approval='$numprove' WHERE id='$_GET[kode]'");
                                        echo "<script>alert('Permintaan Koreksi Absen Berhasil Disetujui');
                                        ...
                                        mysqli_query($conn, "UPDATE absensi SET approval=5 WHERE id='$_GET[kode]'");
                                        echo "<script>alert('Permintaan Koreksi Absen Berhasil Disetujui');
                                         document.location.href='../absensi';</script>";
                                    }
                                }
                                ...
                                if (isset($_GET['kode1'])) {
                                    mysqli_query($conn, "UPDATE absensi SET approval=10 WHERE id='$_GET[kode1]'");
                                    echo "<script>alert('Permintaan Koreksi Absen Berhasil Ditolak..!!');
                                             document.location.href='../absensi';</script>";
                                } ?>
