        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="mt-5 mt-lg-5 px-0 pt-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col card-body tumpul bg-light-biru text-primary" style="background-color: #f4b084;">
                        ...
                        <div class="col-12 card tumpul table-borderless">
                            <table id="datatablesSimple" class="table table-hover table-responsive border" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    include "../../../../koneksi.php";
                                    $no = 1;
                                    // $ambildata = mysqli_query($conn, "SELECT * FROM permit WHERE approval='$_SESSION[role]' && seksi='$_SESSION[seksi]'");

                                    // $ambildata = mysqli_query($conn, "SELECT * FROM permit a INNER JOIN nusametal_id b
                                    //  ON a.seksi=b.seksi
                                    //  WHERE (b.seksi ='$_SESSION[seksi]' OR b.departemen='$_SESSION[departemen]' OR b.divisi='$_SESSION[divisi]' )
                                    //  AND a.approval='$_SESSION[role]' AND a.tanggal_in >= CURRENT_DATE");
                                    error_reporting(1);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $tampil['asal_perusahaan'] ?></td>
                                            <td><?php echo $tampil['keperluan'] ?></td>
                                            <td><?php echo $tampil['tanggal_in'] ?></td>
                                            <td><?php echo $tampil['tanggal_out'] ?></td>
                                            <td><?php echo $tampil['jam_in'] ?></td>
                                            <td><?php echo $tampil['jam_out'] ?></td>
                                            <td><?php echo $tampil['user'] ?></td>
                                            <td><?php echo $tampil['seksi'] ?></td>
                                            <td><?php echo $status ?></td>
                                            <td><?php echo $tampil['approvedby'] ?></td>
                                            <td style="text-align: center;"><a href='index.php?x=<?php echo $tampil['id'] ?>'><i class="btn fa-solid fa-check" style="background-color:green; color: white; height: 30px;" onclick="return confirm('Yakin Untuk Mengizinkan?');"></i></a> </td>
                                            <td style="text-align: center;"><a href='index.php?xa=<?php echo $tampil['id'] ?>'><i class="btn fa-solid fa-x" style="background-color:red; color: white; height: 30px;" onclick="return confirm('Yakin Untuk Menolak?');"></i></a> </td>
                                        </tr>
                                    <?php
                                        $no++;
                                    }
                                ...
                                if (isset($_GET['x'])) {
                                    ...
                                    echo "<script>alert('Berhasil Diizinkan.!');
                                             document.location.href='../masukpabrik';</script>";
                                } else if (isset($_GET['xa'])) {
                                    mysqli_query($conn, "UPDATE permit SET approval=10 , approveby='$_SESSION[nama]' WHERE id='$_GET[xa]'");
                                    echo "<script>alert('Berhasil Ditolak!');
                                             document.location.href='../masukpabrik';</script>";
                                }
                                ?>
