                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col card-body tumpul bg-light-biru text-primary">
                            ...
                            <span>B e r i k u t &ensp; d a f t a r &ensp; K o r e k s i &ensp; A b s e n &ensp; B u l a n &ensp; I n i</span>
                        </div>
                    </div>
                            ...
                            <table id="datatablesSimple" border="1" class="table table-hover table-responsive border" style="color:black">
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "http://localhost/permit/admin/dashboard/download/absensi/download.php?start=" + start + "&end=" + end;
                                    });
